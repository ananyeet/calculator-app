package [MYPACKAGENAME]; // TODO: Change this to your own package name.
...
public class MainActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redSeekBar = findViewById(R.id.[REDSEEKBAR ID]); // TODO
        greenSeekBar = findViewById(R.id.[GREENSEEKBAR ID]); // TODO
        blueSeekBar = findViewById(R.id.[BLUESEEKBAR ID]); // TODO

        final RelativeLayout rl = findViewById(R.id.[RELATIVELAYOUT ID]); // TODO
        ...
        redSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progressValue, boolean fromUser) {
                int redProgress = redSeekBar.getProgress(); // This will get the position of the red seekBar.
                                                            ...
                                                            // 0 and 255.
                int greenProgress = // TODO
                int blueProgress =  // TODO
